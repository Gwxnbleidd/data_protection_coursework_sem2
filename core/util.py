...
import implementation.core.key
...
def private_to_public() -> None:
    ...
    priv_key = implementation.core.key.PrivateKey.load_pkcs1(in_data, cli.inform)
    pub_key = implementation.core.key.PublicKey(priv_key.n, priv_key.e)
